...
const mockSendTextDM = vi
  .fn()
  .mockResolvedValue({ recipient_id: "123", message_id: "m1" });
const mockSendButtonDM = vi
  .fn()
  .mockResolvedValue({ recipient_id: "123", message_id: "m2" });
...
vi.mock("../services/instagram.service.js", () => ({
  ...
  getUserProfile: vi
    .fn()
    .mockResolvedValue({ id: "123", username: "testuser" }),
}));
